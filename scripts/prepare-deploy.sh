...
# 3. Prune History, Raw Data & Vacuum
echo "🧹 Pruning history, raw_data and optimizing..."
sqlite3 data/cleverprices-lite.db "DELETE FROM price_history; UPDATE products SET raw_data = NULL; VACUUM;"
