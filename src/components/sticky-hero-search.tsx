...
export function StickyHeroSearch() {
  ...
  return (
    <div
      className={`bg-background/95 supports-backdrop-filter:bg-background/60 fixed top-14 right-0 left-0 z-40 border-b backdrop-blur transition-all duration-300 ${
